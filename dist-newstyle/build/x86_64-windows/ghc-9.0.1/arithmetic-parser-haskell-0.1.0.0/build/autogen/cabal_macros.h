...
/* package arithmetic-parser-haskell-0.1.0.0 */
#ifndef VERSION_arithmetic_parser_haskell
#define VERSION_arithmetic_parser_haskell "0.1.0.0"
#endif /* VERSION_arithmetic_parser_haskell */
#ifndef MIN_VERSION_arithmetic_parser_haskell
#define MIN_VERSION_arithmetic_parser_haskell(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_arithmetic_parser_haskell */
...
#define CURRENT_PACKAGE_KEY "arithmetic-parser-haskell-0.1.0.0-inplace"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "arithmetic-parser-haskell-0.1.0.0-inplace"
